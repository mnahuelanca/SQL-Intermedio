...
SELECT A.numero, B.numero FROM facturas A
INNER JOIN items_facturas B
ON A.numero = B.numero;

SELECT YEAR(FECHA_VENTA), SUM(CANTIDAD*PRECIO) AS FACTURACION FROM FACTURAS A
INNER JOIN ITEMS_FACTURAS B
ON A.NUMERO = B.NUMERO
GROUP BY YEAR(FECHA_VENTA);

#Usando LEFT JOIN
SELECT A.DNI, A.NOMBRE, B.DNI AS "COMPRO?" FROM TABLA_DE_CLIENTES A
LEFT JOIN FACTURAS B
ON A.DNI = B.DNI;

#Usando CROSS JOIN
SELECT A.NOMBRE, A.CIUDAD, A.BARRIO, B.NOMBRE, B.VACACIONES
